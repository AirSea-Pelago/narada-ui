      ...
      for (const line of lines) {
        ...
        try {
          ...
          if (msg.type === "status") {
            ...
            // Not JSON – forward as a raw log line to the UI
  ...
  return [
    {
      ...
      locked: true,
      settings: {
        mode: "standard", scale: 0.7, threshold: 0.39, fp16: true,
        ...
        stream_fps: 24, stream_width: 0, stream_height: 0, queue_size: 2,
        gpu_id: "0", show: false,
        track: false, multiscale: false, detect_interval: 2, max_drift: 20.0,
        ms_scales: "1.0", ms_threshold: 0.39, ms_nms_radius: 12,
    ...
    },
    {
      ...
      locked: true,
      settings: {
        mode: "traffic", scale: 0.75, threshold: 0.28, fp16: true,
        source_url: "rtmp://localhost:1935/matrice4t", stream_out: "rtmp://localhost:1935/cognitiveOutput",
        ...
        stream_fps: 24, stream_width: 0, stream_height: 0, queue_size: 2,
        gpu_id: "0", show: false,
        track: true, multiscale: false, detect_interval: 10, max_drift: 25.0,
        ms_scales: "0.5,0.75,1.0,1.25", ms_threshold: 0.28, ms_nms_radius: 12,
        stream_preset: "ultrafast",
      },
    },
  ];
